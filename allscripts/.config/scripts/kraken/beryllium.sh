...
git clone https://github.com/ArrowOS/android_device_xiaomi_beryllium -b arrow-12.0
git clone https://github.com/ArrowOS/android_device_xiaomi_sdm845-common -b arrow-12.0
...
git clone https://gitlab.com/the-muppets/proprietary_vendor_xiaomi -b arrow-12.0
...
git filter-branch --prune-empty --subdirectory-filter beryllium arrow-12.0
...
git filter-branch --prune-empty --subdirectory-filter sdm845-common arrow-12.0
...
cd ..
git clone https://github.com/ArrowOS/android_kernel_xiaomi_sdm845 -b arrow-12.0
