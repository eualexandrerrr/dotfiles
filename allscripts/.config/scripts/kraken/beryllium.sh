...
git clone https://github.com/LineageOS/android_device_xiaomi_beryllium -b lineage-19.0
git clone https://github.com/LineageOS/android_device_xiaomi_sdm845-common -b lineage-19.0
...
git clone https://gitlab.com/the-muppets/proprietary_vendor_xiaomi -b lineage-19.0
...
git filter-branch --prune-empty --subdirectory-filter beryllium lineage-19.0
...
git filter-branch --prune-empty --subdirectory-filter sdm845-common lineage-19.0
...
cd ..
git clone https://github.com/LineageOS/android_kernel_xiaomi_sdm845 -b lineage-19.0
