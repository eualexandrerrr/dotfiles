...
hl.bind("CTRL + ALT + Home", hl.dsp.exec_cmd(dotfiles .. "/vm/modo-jogo entrar"))
...
hl.bind(mod .. " + SHIFT + E", hl.dsp.submap("energia"))
...
hl.define_submap("energia", function()
    hl.bind("D", hl.dsp.exec_cmd("systemctl poweroff"))
    hl.bind("R", hl.dsp.exec_cmd("systemctl reboot"))
    hl.bind("S", hl.dsp.exec_cmd("uwsm stop"))
    hl.bind("B", hl.dsp.exec_cmd("uwsm app -- " .. dotfiles .. "/bin/lock.sh"))
    hl.bind("Escape", hl.dsp.submap("reset"))
    hl.bind("Return", hl.dsp.submap("reset"))
end)
