...
local function telas_mudaram()
    hl.exec_cmd(os.getenv("HOME") .. "/.dotfiles/bin/screens-changed.sh")
end
...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("uwsm app -- " .. os.getenv("HOME") .. "/.dotfiles/bin/swaync.sh")
    ...
    hl.exec_cmd(os.getenv("HOME") .. "/.dotfiles/bin/audio.sh")
    hl.exec_cmd(os.getenv("HOME") .. "/.dotfiles/bin/dns-fastest.sh")
    hl.exec_cmd(os.getenv("HOME") .. "/.dotfiles/bin/nvidia-performance.sh")
