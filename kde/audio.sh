...
# "Aumentar o volume maximo" desligado: sem passar de 100% e sem distorcer.
if command -v kwriteconfig6 >/dev/null 2>&1; then
    kwriteconfig6 --file plasmaparc --group General --key RaiseMaximumVolume false
    kwriteconfig6 --file plasmaparc --group General --key VolumeStep 5
    ok "volume maximo travado em 100%"
fi
