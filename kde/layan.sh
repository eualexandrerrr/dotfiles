...
#
# Kvantum e o LayanSolidDark: a variante translucida deixa a janela ilegivel por
# cima de pagina clara.
set -uo pipefail
...
cp -r "$V/kvantum/LayanSolidDark" ~/.config/Kvantum/
cp "$V/colors/Layan.colors" ~/.local/share/color-schemes/
...
kwriteconfig6 --file ~/.config/Kvantum/kvantum.kvconfig --group General --key theme LayanSolidDark
