    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Dream-Dark-SDDM-6/assets/suspend.svg"
                        text: i18ndc("plasma_lookandfeel_org.kde.lookandfeel", "Suspend to RAM", "Sleep")
                        onClicked: sddm.suspend()
                        enabled: sddm.canSuspend
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Dream-Dark-SDDM-6/assets/reboot.svg"
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel", "Restart")
                        onClicked: sddm.reboot()
                        enabled: sddm.canReboot
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Dream-Dark-SDDM-6/assets/shutdown.svg"
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel", "Shut Down")
                        onClicked: sddm.powerOff()
                        enabled: sddm.canPowerOff
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Dream-Dark-SDDM-6/assets/user-prompt.svg"
        ...
        Component {
            ...
            Login {
                ...
                actionItems: [
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/Dream-Dark-SDDM-6/assets/switch-user.svg"
