...
KCMUtils.ScrollViewKCM {
    ...
    function checkUnsavedChanges() {
        calendarPage.unsavedChanges = !(Plasmoid.configuration.enabledCalendarPlugins.every(entry => eventPluginsManager.enabledPlugins.includes(entry))
            && eventPluginsManager.enabledPlugins.every(entry => Plasmoid.configuration.enabledCalendarPlugins.includes(entry)))
    }
